import type { DistributionMethodInputSlice } from "./slice";
...
export const PROFILE_DISTRIBUTION_METHOD_DEFAULT_VALUE: DistributionMethodInputSlice =
  {
    distributionMethodType: PROFILE_DISTRIBUTUIN_METHOD.ALL_USERS.VALUE,
    profileDistributionMethodByConditionCardStatus: "ANY",
    profileDistributionMethodByConditionYesCardIds: [],
    profileDistributionMethodByConditionNoCardIds: [],
    profileDistributionMethodByConditionIsStuff: "ANY",
  };
